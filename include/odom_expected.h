#ifndef ODOM_EXPECTED_H
#define ODOM_EXPECTED_H
...
public:
   ...
   */
  OdomExpected(const MotorConfig& cfg0, const MotorConfig& cfg1, const MotorConfig& cfg2, float delta_t);
  ~OdomExpected();
