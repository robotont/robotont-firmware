...
void ssd1306_WriteCommand(uint8_t byte) {
    i2cif_memoryWrite(SSD1306_I2C_INSTANCE, SSD1306_I2C_ADDR, 0x00, 1, &byte, 1, I2CIF_DEFAULT_TIMEOUT_MS);
}

// Send data
void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    i2cif_memoryWrite(SSD1306_I2C_INSTANCE, SSD1306_I2C_ADDR, 0x40, 1, buffer, buff_size, I2CIF_DEFAULT_TIMEOUT_MS);
}
