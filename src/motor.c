...
{
    double effort_epsilon = 10; // this is a counter value from where the motor exceeds its internal friction, also instabilities in PWM generation occured with lower values.
