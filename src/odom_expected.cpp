#include "odom_expected.h"
#include "MatrixMath.h"

OdomExpected::OdomExpected(const MotorConfig &cfg0, const MotorConfig &cfg1, const MotorConfig &cfg2, float delta_t)
...
OdomExpected::~OdomExpected()
{
}

void OdomExpected::reset()
{
  odom_pos_.Clear();
  odom_vel_.Clear();
}

void OdomExpected::update(float vel_1, float vel_2, float vel_3)
{
